...
class Image < ActiveRecord::Base
  ...
  has_attachment :storage => :file_system, :processor => :rmagick, :max_size => 100.megabytes, :content_type => VALID_TYPES.collect {|key, value| value}, :thumbnails => Medium::CROPPED_SIZES.merge({:search => '70:150x150', :essay => '80:280x280>', :normal => '80:500x500>', :large => '80:800x700>', :huge => '90:2000x2000>'})
  acts_as_tree
